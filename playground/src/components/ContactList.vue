...
/**
 * Contact list WITH normalization.
 * Uses normalize: true — entities are stored in the shared entity store.
 * Updates via entityStore.set() propagate here automatically.
 */
import { useQuery } from "@pinia/colada";
import { fetchContacts, type ContactSummary } from "../api/mock";

defineProps<{ selectedId: string | null; normalized: boolean }>();
...
<template>
  <div class="panel">
    <div class="panel-header">
      <h2>Contact List</h2>
      <code class="query-key">['contacts']</code>
